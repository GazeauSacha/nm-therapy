  ...
  const services = [
    {
      num: "01",
      icon: <LifeIcon />,
      titleKey: "services.01_title",
      descKey: "services.01_desc",
      tagsKey: "services.01_tags",
    },
    {
      num: "02",
      icon: <HeartIcon />,
      titleKey: "services.02_title",
      descKey: "services.02_desc",
      tagsKey: "services.02_tags",
    },
    {
      num: "03",
      icon: <HypnoIcon />,
      titleKey: "services.03_title",
      descKey: "services.03_desc",
      tagsKey: "services.03_tags",
    },
    {
      num: "04",
      icon: <CoupleIcon />,
      titleKey: "services.04_title",
      descKey: "services.04_desc",
      tagsKey: "services.04_tags",
    },
    {
      num: "05",
      icon: <EyeIcon />,
      titleKey: "services.05_title",
      descKey: "services.05_desc",
      tagsKey: "services.05_tags",
    },
    {
      num: "06",
      icon: <StarIcon />,
      titleKey: "services.06_title",
      descKey: "services.06_desc",
      tagsKey: "services.06_tags",
    },
  ];
    ...
    <div>
      ...
      <section className={s.services} id="services">
        <div className={`${s.servicesHeader} reveal`}>
          <p className={`${s.eyebrow} ${s.eyebrowCenter}`}>
            {t("services.eyebrow")}
          </p>
          <h2 className={s.sectionTitle}>
            ...
            <div key={svc.num} className={`${s.serviceCard} reveal`}>
              ...
              <div className={s.serviceTags}>
                {t(svc.tagsKey)
                  .split("|")
                  .map((tag) => (
                    <span key={tag} className={s.serviceTag}>
                      {tag}
                    </span>
                  ))}
              </div>
      ...
      <section className={s.process} id="approche">
        ...
        <div className={`${s.processVisual} reveal`}>
          <div className={s.mandala}>
            <div className={s.mandalaCenter}>∞</div>
          </div>
        </div>
      </section>
